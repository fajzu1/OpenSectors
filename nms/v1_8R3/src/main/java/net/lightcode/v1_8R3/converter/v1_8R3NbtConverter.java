package net.lightcode.v1_8R3.converter;
...
public class v1_8R3NbtConverter implements NbtConverter<Object> {

    @Override
    public Object convertStringToNBTCompound(String nbtString) {
        try {
            Class<?> mojangsonParserClass = Class.forName("net.minecraft.server.v1_8_R3.MojangsonParser");
