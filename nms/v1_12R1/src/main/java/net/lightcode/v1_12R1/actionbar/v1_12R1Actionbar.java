package net.lightcode.v1_12R1.actionbar;
...
public class v1_12R1Actionbar implements Actionbar {
    @Override
    public void sendActionBar(Player player, String message) {
        try {
            ...
            Class<?> iChatBaseComponent = Class.forName("net.minecraft.server.v1_12_R1.IChatBaseComponent");
            ...
            Class<?> packetPlayOutChat = Class.forName("net.minecraft.server.v1_12_R1.PacketPlayOutChat");
