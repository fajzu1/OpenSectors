package net.lightcode.v1_13R2.converter;
...
public class v1_13R2NbtConverter implements NbtConverter<Object> {

    @Override
    public Object convertStringToNBTCompound(String nbtString) {
        try {
            Class<?> mojangsonParserClass = Class.forName("net.minecraft.server.v1_13_R2.MojangsonParser");
