package net.lightcode.v1_13R2.data;

import net.lightcode.data.Data;
import org.bukkit.entity.Player;

public class v1_13R2Data implements Data<Player, Object> {
    @Override
    public String saveData(Player player) {
        try {
            ...
            Class<?> nbtClass = Class.forName("net.minecraft.server.v1_13_R2.NBTTagCompound");
