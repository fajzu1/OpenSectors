package net.lightcode.v1_8R3.data;

import net.lightcode.data.Data;
import org.bukkit.entity.Player;

public class v1_9R2Data implements Data<Player, Object> {
    @Override
    public String saveData(Player player) {
        try {
            ...
            Class<?> nbtClass = Class.forName("net.minecraft.server.v1_9_R2.NBTTagCompound");
