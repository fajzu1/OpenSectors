...
public class v1_9R2Border implements Border {
    ...
    public void sendWorldBorder(Player player, double size, double centerX, double centerZ) {
        try {
            ...
            Class<?> enumBorderAction = Class.forName("net.minecraft.server.v1_9_R2.PacketPlayOutWorldBorder$EnumWorldBorderAction");
            Object initializeAction = Enum.valueOf((Class<Enum>) enumBorderAction, "INITIALIZE");

            Constructor<?> packetConstructor = Class.forName("net.minecraft.server.v1_9_R2.PacketPlayOutWorldBorder")
            ...
            Method sendPacket = playerConnection.getClass().getMethod("sendPacket", Class.forName("net.minecraft.server.v1_9_R2.Packet"));
