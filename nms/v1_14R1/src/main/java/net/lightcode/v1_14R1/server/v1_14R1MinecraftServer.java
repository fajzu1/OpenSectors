package net.lightcode.v1_14R1.server;

import net.lightcode.server.MinecraftServer;

import java.lang.reflect.Field;

public class v1_14R1MinecraftServer implements MinecraftServer {
    @Override
    public double tps() {
        try {
            Class<?> minecraftServerClass = Class.forName("net.minecraft.server.v1_14_R1.MinecraftServer");
