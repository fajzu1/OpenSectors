package net.lightcode.v1_11R1.converter;
...
public class v1_11R1NbtConverter implements NbtConverter<Object> {

    @Override
    public Object convertStringToNBTCompound(String nbtString) {
        try {
            Class<?> mojangsonParserClass = Class.forName("net.minecraft.server.v1_11_R1.MojangsonParser");
