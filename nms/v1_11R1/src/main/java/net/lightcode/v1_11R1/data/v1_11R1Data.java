package net.lightcode.v1_11R1.data;

import net.lightcode.data.Data;
import org.bukkit.entity.Player;

public class v1_11R1Data implements Data<Player, Object> {
    @Override
    public String saveData(Player player) {
        try {
            ...
            Class<?> nbtClass = Class.forName("net.minecraft.server.v1_11_R1.NBTTagCompound");
